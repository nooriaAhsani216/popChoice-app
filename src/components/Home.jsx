...
export default function Home({onStart}) {
    return (
       ...
       <div className="text-center space-y-2 m-5">
             <h1 className="text-3xl font-bold bg-linear-to-r from-yellow-200 via-yellow-400 to-amber-600 bg-clip-text text-transparent">
                Your Personalized Movie Guide
            </h1>
            <h2 className="font-bold bg-linear-to-r from-yellow-200 via-yellow-400 to-amber-600 bg-clip-text text-transparent">Discover your next favorite movie with AI-powered recommendations.</h2>
            <button 
            onClick={onStart} 
